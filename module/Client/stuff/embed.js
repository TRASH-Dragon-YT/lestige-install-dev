...
module.exports = class DiscordEmbed {
    ...
    setColor(color){
        ...
        if(color == 'random' || 'RANDOM' || 'rnd'){
            ...
            var random = cchar[Math.floor(Math.random() * cchar.length)]
            

         this.embed.color = formatColor(random)
        }else{
    ...
    addField(fieldName, fieldValue, inline){
        ...
        if(typeof inline !== 'boolean'){
            throw new Error("[Lestige]: Inline should be a boolean (True/False)")
        }
